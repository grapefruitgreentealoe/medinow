...
export class UpdateProfile1744738921631 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user_profile" DROP CONSTRAINT "FK_572546c5c4c36796e8af87502cd"`);
        ...
        await queryRunner.query(`ALTER TABLE "user_profile" ADD CONSTRAINT "FK_572546c5c4c36796e8af87502cd" FOREIGN KEY ("careUnitId") REFERENCES "care_unit"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user_profile" ADD CONSTRAINT "FK_572546c5c4c36796e8af87502cd" FOREIGN KEY ("careUnitId") REFERENCES "care_unit"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
