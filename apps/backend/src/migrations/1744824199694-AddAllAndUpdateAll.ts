...
export class AddAllAndUpdateAll1744824199694 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "care_unit" ALTER COLUMN "name" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP CONSTRAINT "UQ_b4b96513b1e4db7b8f967e98b75"`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "mondayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "mondayOpen" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "mondayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "mondayClose" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "tuesdayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "tuesdayOpen" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "tuesdayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "tuesdayClose" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "wednesdayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "wednesdayOpen" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "wednesdayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "wednesdayClose" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "thursdayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "thursdayOpen" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "thursdayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "thursdayClose" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "fridayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "fridayOpen" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "fridayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "fridayClose" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "saturdayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "saturdayOpen" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "saturdayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "saturdayClose" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "sundayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "sundayOpen" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "sundayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "sundayClose" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "holidayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "holidayOpen" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "holidayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "holidayClose" double precision`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "lat"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "lat" double precision NOT NULL`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "lng"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "lng" double precision NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "role"`);
        await queryRunner.query(`CREATE TYPE "public"."user_role_enum" AS ENUM('USER', 'ADMIN', 'SUPER-ADMIN')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "lng"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "lng" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "lat"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "lat" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "holidayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "holidayClose" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "holidayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "holidayOpen" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "sundayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "sundayClose" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "sundayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "sundayOpen" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "saturdayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "saturdayClose" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "saturdayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "saturdayOpen" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "fridayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "fridayClose" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "fridayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "fridayOpen" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "thursdayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "thursdayClose" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "thursdayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "thursdayOpen" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "wednesdayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "wednesdayClose" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "wednesdayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "wednesdayOpen" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "tuesdayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "tuesdayClose" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "tuesdayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "tuesdayOpen" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "mondayClose"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "mondayClose" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" DROP COLUMN "mondayOpen"`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD "mondayOpen" character varying`);
        await queryRunner.query(`ALTER TABLE "care_unit" ADD CONSTRAINT "UQ_b4b96513b1e4db7b8f967e98b75" UNIQUE ("hpId")`);
        await queryRunner.query(`ALTER TABLE "care_unit" ALTER COLUMN "name" SET NOT NULL`);
