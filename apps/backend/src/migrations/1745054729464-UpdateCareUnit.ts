...
export class UpdateCareUnit1745054729464 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "favorites" DROP COLUMN "care_unit_id"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "care_unit" ADD "isBadged" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "care_unit" ADD "nowOpen" boolean NOT NULL DEFAULT true`,
    );
    await queryRunner.query(
      `ALTER TABLE "care_unit" ADD "kakaoUrl" character varying`,
    );
    await queryRunner.query(
      `ALTER TYPE "public"."images_type_enum" RENAME TO "images_type_enum_old"`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."images_type_enum" AS ENUM('userProfile', 'careUnit', 'businessLicense')`,
    );
    await queryRunner.query(
      `ALTER TABLE "images" ALTER COLUMN "type" TYPE "public"."images_type_enum" USING "type"::"text"::"public"."images_type_enum"`,
    );
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_d7b2ca5e4f6ef01b772bd4c5a0" ON "favorites" ("userId", "careUnitId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "favorites" ADD CONSTRAINT "FK_ea0a851f389fca88f670035400b" FOREIGN KEY ("careUnitId") REFERENCES "care_unit"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "favorites" DROP CONSTRAINT "FK_ea0a851f389fca88f670035400b"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."user_role_enum_old" AS ENUM('USER', 'ADMIN', 'SUPER-ADMIN')`,
    );
    await queryRunner.query(
      `ALTER TABLE "user" ALTER COLUMN "role" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."images_type_enum_old" AS ENUM('user_profile', 'care_unit', 'business_license')`,
    );
    await queryRunner.query(
      `ALTER TABLE "images" ALTER COLUMN "type" TYPE "public"."images_type_enum_old" USING "type"::"text"::"public"."images_type_enum_old"`,
    );
    await queryRunner.query(`DROP TYPE "public"."images_type_enum"`);
    await queryRunner.query(
      `ALTER TYPE "public"."images_type_enum_old" RENAME TO "images_type_enum"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "care_unit" ADD "kakao_url" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "care_unit" ADD "now_open" boolean NOT NULL DEFAULT true`,
    );
    await queryRunner.query(
      `ALTER TABLE "care_unit" ADD "is_badged" boolean NOT NULL DEFAULT false`,
    );
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_09661eb38361553044b5dc26d5" ON "favorites" ("care_unit_id", "user_id") `,
    );
    await queryRunner.query(
